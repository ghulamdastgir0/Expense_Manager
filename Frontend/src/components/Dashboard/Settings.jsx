...
function Settings({ onNavigate, onSettingsSaved }) {
  ...
  const handleSave = async (e) => {
    ...
    if (!timezoneId) {
      setSaveError("Please select a timezone.");
      return;
    }
    if (
      budgetLimit &&
      (isNaN(parseFloat(budgetLimit)) || parseFloat(budgetLimit) < 0)
    ) {
  ...
  const handlePasswordChange = async () => {
    ...
    if (newPassword === currentPassword && newPassword)
      errors.new = "New password must differ from current.";
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <form onSubmit={handleSave} className="space-y-8">
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Affects all amount displays across the app
                  </p>
                </div>
              </div>
              ...
              <div className="relative" ref={currencyRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-6 h-6 text-gray-600 transition-transform duration-200 ${showCurrencyDD ? "rotate-180" : ""}`}
                  />
                </button>
          ...
          <Box
            ...
            subtitle="All transaction times will display in this timezone"
            className="shadow-2xl"
          >
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Transaction dates & times update immediately on all pages
                  </p>
                </div>
              </div>
              ...
              <div className="relative" ref={timezoneRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-6 h-6 text-gray-600 transition-transform duration-200 ${showTimezoneDD ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div className="flex items-center gap-3 mt-6 p-4 bg-gray-800/50 rounded-xl">
                ...
                <span className="font-mono text-xl text-[#4ADE80] font-bold">
                  {liveTime}
                </span>
              </div>
              <p className="text-xs text-gray-500 mt-2 pl-1">
                Offset: {utcOffset} — All transaction timestamps on History,
                Transactions, and Reports pages reflect this timezone.
              </p>
            </div>
          </Box>
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Dashboard and Add Transaction will show your progress
                  </p>
                </div>
              </div>
              <input
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-900/20 rounded-xl border border-blue-500/30 mt-4">
                ...
                <p className="text-sm text-blue-300">
                  You'll receive a warning on the Dashboard when you reach 80%
                  of this limit, and an alert when you exceed it.
                </p>
              </div>
            </div>
          </Box>
          ...
          {/* Feedback */}
          {saveSuccess && (
            <p className="text-green-400 text-sm bg-green-900/20 border border-green-700 rounded-lg px-4 py-2">
              ✓ {saveSuccess}
            </p>
          )}
          {saveError && (
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 p-6 bg-red-900/10 rounded-xl border border-red-500/30">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-300">
                      Removes all history and resets balance to zero
                    </p>
                  </div>
                </div>
                {!showDeleteDataConfirm ? (
                  <button
                    ...
                    className="inline-flex items-center gap-3 bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg"
                  >
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-lg"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg"
                    >
                      <X className="w-4 h-4" />
                      Cancel
                    </button>
