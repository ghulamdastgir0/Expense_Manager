...
function TransactionsPage({ onNavigate, onAddTransaction }) {
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 lg:p-8 bg-black text-white space-y-8">
      ...
      <Box title="Quick Actions" subtitle="Manage your finances" className="shadow-lg max-w-5xl">
        ...
        <Box title="Transaction Summary" subtitle="This month overview" className="shadow-lg">
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-red-900/20 rounded-lg">
              ...
              <span className="text-red-400 font-bold">$263.91</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-blue-900/20 rounded-lg">
              <span className="text-white text-sm">Net Amount</span>
              <span className="text-blue-400 font-bold">$2,236.09</span>
            </div>
